...
exports.updateProfil = (req,res) => {
    ...
    if (req.body.userName && req.body.email && req.body.lastName && req.body.firstName && req.body.bio && req.body.birthDate && req.body.showMe && (req.body.profileComplete || req.body.profileComplete === false) && req.body.saveEmail && req.body.gender) {
